  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(15,118,110,0.18),_rgba(2,6,23,0.96))]" />
        <div className="absolute left-1/4 top-1/4 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-teal-500/20 blur-[140px]" />
        <div className="absolute right-[-10%] top-1/3 h-[360px] w-[360px] rounded-full bg-sky-500/20 blur-[160px]" />
        <div className="absolute bottom-[-20%] left-1/3 h-[520px] w-[520px] rounded-full bg-indigo-500/20 blur-[200px]" />
      </div>
      ...
      <header className="border-b border-white/10 bg-slate-950/70 backdrop-blur-sm">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6 sm:px-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button asChild className="shadow-[0_12px_40px_rgba(56,189,248,0.35)]">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-20 px-6 py-12 sm:px-10 sm:py-16">
        <section className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-8">
            <span className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.4em] text-sky-200">
              AI Study Buddy
            </span>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Button asChild size="lg" className="px-7 text-base shadow-[0_18px_45px_rgba(14,165,233,0.35)]">
          ...
          <Card className="border-white/10 bg-white/5 text-white shadow-[0_25px_80px_rgba(56,189,248,0.15)]">
            ...
            <CardContent className="space-y-4 text-sm text-slate-200">
              <div className="rounded-lg border border-white/10 bg-slate-950/50 p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-sky-200">今日亮点</p>
                <p className="mt-2 text-lg text-white">任务完成度 82%</p>
                <p className="text-slate-300">下一个建议：完成面试行为题演练 1 轮。</p>
              </div>
              <div className="rounded-lg border border-white/10 bg-slate-950/50 p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-sky-200">情感播报</p>
            ...
            {FEATURES.map((feature) => (
              <Card
                ...
                className={cn(
                  ...
                  "hover:border-white/30 hover:bg-white/10 hover:shadow-[0_25px_60px_rgba(56,189,248,0.2)]",
                )}
              >
        ...
        <section className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 px-8 py-12 text-white shadow-[0_35px_90px_rgba(14,165,233,0.18)] sm:px-12">
