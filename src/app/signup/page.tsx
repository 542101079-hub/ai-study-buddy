              ...
              <CardContent className="space-y-6">
                <form className="space-y-5" onSubmit={handleSubmit} noValidate>
                  ...
                  <div className="space-y-3">
                      ...
                      {STAGES.map((item) => {
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              "flex h-full flex-col gap-1 rounded-xl border border-white/10 bg-white/5 p-4 text-left transition-all",
                              "hover:border-white/30 hover:bg-white/10",
                              isActive &&
                                "border-sky-400/60 bg-sky-500/20 shadow-[0_18px_45px_rgba(14,165,233,0.25)]",
                              loading && "cursor-not-allowed opacity-70",
                            )}
                          >
                            <span className="text-sm font-semibold text-white">{item.label}</span>
                            <span className="text-xs text-sky-200">{item.headline}</span>
                    ...
                    {stageMeta && (
                      <div className="rounded-lg border border-white/10 bg-slate-950/40 px-4 py-3 text-xs text-slate-200">
