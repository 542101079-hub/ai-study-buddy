  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.16),_rgba(2,6,23,0.98))]" />
        <div className="absolute left-2/3 top-1/4 h-[420px] w-[420px] rounded-full bg-sky-500/20 blur-[120px]" />
        <div className="absolute right-1/3 bottom-1/4 h-[360px] w-[360px] rounded-full bg-violet-500/20 blur-[140px]" />
      </div>
      <div className="flex min-h-screen flex-col lg:flex-row">
        ...
        <aside className="relative hidden flex-1 flex-col justify-between overflow-hidden border-t border-white/10 bg-white/5 px-6 py-12 text-white md:px-10 lg:px-12 lg:py-16 lg:flex">
          <div className="space-y-10">
            ...
            <ul className="space-y-4 text-sm text-slate-200">
              {SIDE_NOTES.map((note) => (
                ...
                >
                  <span className="flex h-7 w-7 items-center justify-center rounded-full bg-sky-500/40 text-sm font-semibold text-white">
                    \u2605
                  </span>
                  <span>{note}</span>
                </li>
